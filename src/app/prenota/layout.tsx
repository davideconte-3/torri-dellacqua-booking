...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${SITE_URL}/og-sanvalentino.jpg`,
        width: 1200,
        height: 630,
        alt: 'San Valentino 2026 - Torri Dell\'Acqua',
      },
    ],
  },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Cena di San Valentino di San Valentino con menu degustazione',
            ...
            location: {
              ...
              address: {
                '@type': 'PostalAddress',
                streetAddress: 'Via Dante Alighieri n. 8',
