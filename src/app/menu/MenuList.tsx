...
const dark = {
  ...
  searchInput: 'bg-slate-800 border-white/30 text-white placeholder-white/65 focus:ring-white/30 focus:border-white/40 focus:bg-slate-700',
  searchClear: 'text-white/70 hover:text-white',
  searchCount: 'text-white/90',
  card: 'border-white/30 bg-slate-800 hover:border-white/40 shadow-black/20 text-white',
  cardOpen: 'border-white/30 bg-slate-800 hover:border-white/40 shadow-black/20 text-white',
  cardBtn: 'hover:bg-slate-700/40',
  cardBtnOpen: 'hover:bg-slate-700/40',
  focusRing: 'focus:ring-white/30',
  categoryName: 'text-white',
  chevron: 'text-white/85',
  listBorder: 'border-white/25',
  item: 'border-white/12 hover:bg-slate-700/25',
  itemLine: 'bg-white/40',
  itemName: 'text-white group-hover:text-white',
  itemDesc: 'text-white/85 group-hover:text-white/95',
  price: 'text-white',
