...
// Night mode: sfondo scuro solido (#252d38) per search e card, nessun bianco
const dark = {
  empty: 'text-white/90',
  searchIcon: 'text-white/70 group-focus-within:text-white',
  searchInput: 'bg-[#252d38] border-white/25 text-white placeholder-white/60 focus:ring-white/30 focus:border-white/40 shadow-none',
  searchClear: 'text-white/70 hover:text-white',
  searchCount: 'text-white/85',
  card: 'border-white/25 bg-[#252d38] hover:border-white/35 shadow-black/20',
  cardOpen: 'border-white/25 bg-[#252d38] hover:border-white/35 shadow-black/20',
  cardBtn: 'hover:bg-white/[0.06]',
  cardBtnOpen: 'hover:bg-white/[0.06]',
  focusRing: 'focus:ring-white/30',
  categoryName: 'text-white',
  chevron: 'text-white/88',
