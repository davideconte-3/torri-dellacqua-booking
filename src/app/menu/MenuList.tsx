...
// Night mode: colori Tailwind standard (slate-800/700) per garantire generazione, tutti i testi bianchi
const dark = {
  empty: '!text-white',
  searchIcon: '!text-white/70 group-focus-within:!text-white',
  searchInput: '!bg-slate-800 !border-white/30 !text-white placeholder:!text-white/65 focus:!ring-white/35 focus:!border-white/45 focus:!bg-slate-700',
  searchClear: '!text-white/70 hover:!text-white',
  searchCount: '!text-white/90',
  card: '!border-white/30 !bg-slate-800 hover:!border-white/40 !shadow-black/25',
  cardOpen: '!border-white/30 !bg-slate-800 hover:!border-white/40 !shadow-black/25',
  cardBtn: 'hover:!bg-slate-700/50',
  cardBtnOpen: 'hover:!bg-slate-700/50',
  focusRing: 'focus:!ring-white/35',
  categoryName: '!text-white',
  chevron: '!text-white/90',
  listBorder: '!border-white/25',
  item: '!border-white/15 hover:!bg-slate-700/30',
  itemLine: '!bg-white/45',
  itemName: '!text-white group-hover:!text-white',
  itemDesc: '!text-white/88 group-hover:!text-white/98',
  price: '!text-white',
  priceLine: '!bg-white/45',
