...
const light = {
  empty: 'text-gray-500',
  searchIcon: 'text-gray-400 group-focus-within:text-gray-600',
  searchInput: 'bg-gray-100 border-gray-200 text-gray-900 placeholder-gray-500 focus:ring-gray-300 focus:border-gray-400 focus:bg-white',
  searchClear: 'text-gray-400 hover:text-gray-600',
  searchCount: 'text-gray-500',
  card: 'border-gray-200 bg-gray-50/80 hover:border-gray-300 shadow-gray-200/30',
  cardOpen: 'border-gray-300 shadow-gray-300/40',
  cardBtn: 'hover:bg-gray-100',
  cardBtnOpen: 'bg-gray-100',
  focusRing: 'focus:ring-gray-200',
  categoryName: 'text-gray-900',
  chevron: 'text-gray-500',
  listBorder: 'border-gray-100',
  item: 'border-gray-100 hover:bg-gray-50',
  itemLine: 'bg-gray-300',
  itemName: 'text-gray-900 group-hover:text-gray-900',
  itemDesc: 'text-gray-600 group-hover:text-gray-700',
  price: 'text-gray-900',
  priceLine: 'bg-gray-300',
  scrollbarThumb: 'rgba(0,0,0,0.15)',
  scrollbarThumbHover: 'rgba(0,0,0,0.25)',
};
const dark = {
  empty: 'text-white/80',
  searchIcon: 'text-white/50 group-focus-within:text-white/70',
  searchInput: 'bg-white/20 border-white/30 text-gray-900 placeholder-white/60 focus:ring-white/40 focus:border-white/50 focus:bg-white/30 focus:shadow-white/10',
  searchClear: 'text-white/50 hover:text-white',
  searchCount: 'text-white/60',
  card: 'border-white/20 bg-white/[0.07] hover:border-white/50 shadow-black/10',
  cardOpen: 'border-white/40 shadow-black/20',
  cardBtn: 'hover:bg-white/10',
  cardBtnOpen: 'bg-white/10',
  focusRing: 'focus:ring-white/30',
  categoryName: 'text-white',
  chevron: 'text-white/70',
  listBorder: 'border-white/15',
  item: 'border-white/8 hover:bg-white/5',
  itemLine: 'bg-white/30',
  itemName: 'text-white group-hover:text-white',
  itemDesc: 'text-white/60 group-hover:text-white/70',
  price: 'text-white',
  priceLine: 'bg-white/30',
